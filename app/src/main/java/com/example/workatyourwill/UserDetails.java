...
//        addAddress=findViewById(R.id.addAddress);
        ...
        DocumentReference collectionReference=firebaseFirestore.collection("users").document(firebaseUser.getUid());
...
//
                    startActivity(new Intent(UserDetails.this,UserHome.class));
                    finish();
...
//                } else {
//                    getLastLocation();
////                    Intent intent=new Intent(UserDetails.this,AddAddress.class);
...
//        });
        bt_Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!user_FullName.isEmpty()&&!user_Phone.isEmpty()&&Latitude!=0&&Latitude!=0){
                    DocumentReference documentReference1=firebaseFirestore.collection("users").document(firebaseUser.getUid());
                     User user=new User(firebaseUser.getUid(),user_FullName,user_Phone,new GeoPoint(Latitude,Longitude));
                    documentReference1.set(user).addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(UserDetails.this,"Submitted Succesfully.",Toast.LENGTH_SHORT).show();
                         startActivity(new Intent(UserDetails.this,UserHome.class));
                    ...
                    Toast.makeText(UserDetails.this,"Fields are emtpy!",Toast.LENGTH_LONG).show();
                }
            }
        });
...
//                            geoFirestore.setLocation(firebaseUser.getUid(), new GeoPoint(mLastLocation.getLatitude(), mLastLocation.getLongitude()));
                            ...
                            Toast.makeText(UserDetails.this,mLastLocation.getLatitude()+","+mLastLocation.getLongitude(),Toast.LENGTH_SHORT).show();
...
//                Toast.makeText(UserDetails.this,user_Loc_Lat+","+user_Loc_Long,Toast.LENGTH_SHORT).show();
//            }
//        }
//    }
