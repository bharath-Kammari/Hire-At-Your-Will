...
public class UsedServices extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query=firebaseFirestore.collection("users").document(firebaseUser.getUid()).collection("myOrders").orderBy("delivered_on", Query.Direction.DESCENDING);
...
//                String docId=serviceAdapter.getSnapshots().getSnapshot(position).getId();
                ...
                Toast.makeText(UsedServices.this,serv_title,Toast.LENGTH_SHORT).show();
...
//                String businessName=model.getBusiness_name();
                ...
                documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        ...
                        geocoder = new Geocoder(UsedServices.this, Locale.getDefault());
                        try {
                            addresses = geocoder.getFromLocation(lat, lng, 1); // Here 1 represent max location result to returned, by documents it recommended 1 to 5
                        }
                        catch (Exception e){
                            Toast.makeText(UsedServices.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                        }
...
//                        String knownName = addresses.get(0).getFeatureName();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(UsedServices.this,"failed to get Values",Toast.LENGTH_SHORT).show();
                    }
                });

                Toast.makeText(UsedServices.this,"Success",Toast.LENGTH_SHORT).show();
